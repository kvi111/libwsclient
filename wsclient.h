...
void libwsclient_onmessage(wsclient *client, void *pfun);
void libwsclient_onopen(wsclient *client, void *pfun);
void libwsclient_onerror(wsclient *client, void *pfun);
void libwsclient_onclose(wsclient *client, void *pfun);
void libwsclient_send(wsclient *client, char *str);
